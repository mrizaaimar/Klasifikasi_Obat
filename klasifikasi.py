...
if st.button('Hasil Prediksi'):
    ...
    if (prediksi [0] == 0):
        prediksi = 'Obat yang disarankan adalah obat A (obat cair)'
    elif(prediksi == 1):
        prediksi = 'Obat yang disarankan adalah obat B (obat suntik)'
    elif(prediksi == 2):
        prediksi = 'Obat yang disarankan adalah obat C (inhaler)'
    elif(prediksi == 3):
        prediksi = 'Obat yang disarankan adalah obat X (obat kapsul)'
    else:
        prediksi = 'Obat yang disarankan adalah obat Y (obat tablet)'
st.success(prediksi)